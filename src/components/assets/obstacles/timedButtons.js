...
function timedButtons(x, z, scene, global_objects, item_id, camera) {
  ...
  function generateButton(x, z, barrier_name, button_name, button_color, holder_color, color_name) {
    ...
    buttonHolder.material.diffuseColor = holder_color;
    ...
    pushButton.material.diffuseColor = button_color;
  ...
  generateButton(x, z, "button1p16", "pushButton1p16", new Color3(0.64, 0.11, 0.11), new Color3(0.37, 0.32, 0.32), null);
  generateButton((x - 20), (z + 20), "button2p16", "pushButton2p16", buttonColors[0].button_code, buttonColors[0].holder_code, buttonColors[0].color_name);
  generateButton((x + 20), (z - 20), "button3p16", "pushButton3p16", buttonColors[1].button_code, buttonColors[1].holder_code, buttonColors[1].color_name);
  generateButton((x - 20), (z - 20), "button4p16", "pushButton4p16", buttonColors[2].button_code, buttonColors[2].holder_code, buttonColors[2].color_name);
  generateButton((x + 20), (z + 20), "button5p16", "pushButton5p16", buttonColors[3].button_code, buttonColors[3].holder_code, buttonColors[3].color_name);
  ...
  connectBox1.material.diffuseColor = new Color3(0.34, 0.34, 0.33);
  ...
  connectBox2.material.diffuseColor = new Color3(0.34, 0.34, 0.33);

  let controlBase = MeshBuilder.CreateBox("box", {width: 10, height: 0.2, depth: 10}, scene);
  ...
  controlBase.material.diffuseColor = new Color3(0.18, 0.15, 0.09);
  ...
  controlBase1.material.diffuseColor = new Color3(0.18, 0.15, 0.09);
  ...
  controlBase2.material.diffuseColor = new Color3(0.18, 0.15, 0.09);
  ...
  controlBase3.material.diffuseColor = new Color3(0.18, 0.15, 0.09);
  ...
  controlBase4.material.diffuseColor = new Color3(0.18, 0.15, 0.09);
  ...
  function generatePole(x, z, bulb_name, bulb_color) {
    ...
    pole.material.diffuseColor = new Color3(0, 0, 0);
  ...
  polesBase1.material.diffuseColor = new Color3(0.31, 0.33, 0.27);
  ...
  polesBase2.material.diffuseColor = new Color3(0.31, 0.33, 0.27);
  ...
  polesBarrier1.material.diffuseColor = new Color3(0.37, 0.32, 0.32);
  ...
  polesBarrier2.material.diffuseColor = new Color3(0.37, 0.32, 0.32);
