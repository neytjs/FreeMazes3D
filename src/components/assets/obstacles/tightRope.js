...
function tightRope(x, z, scene, global_objects, item_id, camera) {
  let acidColors = [
    { acid_color: new Color3(0.94, 0.32, 0.13), bubble_color: new Color3(0.97, 0.4, 0.01) },
    { acid_color: new Color3(0.27, 0.97, 0.1), bubble_color: new Color3(0.25, 0.85, 0.1) },
    { acid_color: new Color3(0.84, 0.1, 0.97), bubble_color: new Color3(0.73, 0.1, 0.84) }
  ];
...
// START for /ASSETS
  ...
  theExitBase1.material.diffuseColor = new Color3(0.49, 0.33, 0.14);
  ...
  theStartBase1.material.diffuseColor = new Color3(0.49, 0.33, 0.14);
  ...
  rail1.material.diffuseColor = new Color3(0.23, 0.19, 0.05);
  ...
  rail2.material.diffuseColor = new Color3(0.23, 0.19, 0.05);
  ...
  rung1.material.diffuseColor = new Color3(0.23, 0.19, 0.05);
  ...
  rung2.material.diffuseColor = new Color3(0.23, 0.19, 0.05);
  ...
  rung3.material.diffuseColor = new Color3(0.23, 0.19, 0.05);
  ...
  rung4.material.diffuseColor = new Color3(0.23, 0.19, 0.05);
  ...
  rung5.material.diffuseColor = new Color3(0.23, 0.19, 0.05);
  ...
  tightRope.material.diffuseColor = new Color3(0.65, 0.59, 0.41);
  ...
  pitWall1.material.diffuseColor = new Color3(0.76, 0.76, 0.76);
  ...
  pitWall2.material.diffuseColor = new Color3(0.76, 0.76, 0.76);

  let pitWall3 = MeshBuilder.CreateBox("box", {width: 14, height: 3, depth: 1}, scene);
  pitWall3.position.y = 1.5;
  pitWall3.position.z = -15.5;
  pitWall3.material = new StandardMaterial('texture1', scene);
  pitWall3.material.diffuseColor = new Color3(0.76, 0.76, 0.76);

  let pitWall4 = MeshBuilder.CreateBox("box", {width: 14, height: 3, depth: 1}, scene);
  pitWall4.position.y = 1.5;
  pitWall4.position.z = 15.5;
  pitWall4.material = new StandardMaterial('texture1', scene);
  pitWall4.material.diffuseColor = new Color3(0.76, 0.76, 0.76);
  ...
  pitAcid.material.diffuseColor = acidColors[0].acid_color;
  ...
  bubble1.material.diffuseColor = acidColors[0].bubble_color;
  ...
  bubble1Particles.addColorGradient(0, acidColors[0].acid_color);
  ...
  bubble2.material.diffuseColor = acidColors[0].bubble_color;
  ...
  bubble2Particles.addColorGradient(0, acidColors[0].acid_color);
  ...
  bubble3.material.diffuseColor = acidColors[0].bubble_color;
  ...
  bubble3Particles.addColorGradient(0, acidColors[0].acid_color);
  ...
  acidDeath.material.diffuseColor = new Color3(0, 0, 0);
  ...
  tombstone1.material.diffuseColor = new Color3(0.52, 0.5, 0.5);

  let tombstone2 = MeshBuilder.CreateCylinder("cylinder", {diameter: 3, height: 1, tessellation: 20}, scene);
  tombstone2.position.y = 2.7;
  tombstone2.rotation.x = 1.57;
  tombstone2.material = new StandardMaterial('texture1', scene);
  tombstone2.material.diffuseColor = new Color3(0.52, 0.5, 0.5);
  ...
  let board1 = MeshBuilder.CreateBox("box", {width: 0.25, height: 0.8, depth: 12}, scene);
  board1.position.y = 0.4;
  board1.position.x = x - 23;
  board1.position.z = z + 16;
  board1.material = new StandardMaterial('texture1', scene);
  board1.material.diffuseColor = new Color3(0.53, 0.36, 0.18);

  let board2 = MeshBuilder.CreateBox("box", {width: 0.25, height: 0.8, depth: 12}, scene);
  board2.position.y = 0.4;
  board2.position.x = x - 17;
  board2.position.z = z + 16;
  board2.material = new StandardMaterial('texture1', scene);
  board2.material.diffuseColor = new Color3(0.53, 0.36, 0.18);
  ...
  board3.material.diffuseColor = new Color3(0.53, 0.36, 0.18);
  ...
  board4.material.diffuseColor = new Color3(0.53, 0.36, 0.18);
  ...
  dirt.material.diffuseColor = new Color3(0.17, 0.1, 0.04);   
}
