...
import {returnMetalTexture, returnLiquidTexture, returnFloorTexture, returnWoodTexture,
  returnTreeTexture, returnCrystalTexture, returnStoneTexture, genCylinderFaceUV,
  genCubeFaceUV} from "../textures.js";

function growGarden(x, z, scene, global_objects, item_id, camera, global_language) {
  ...
  generateWateringCan("item", scene, x, (z + 10), 0, camera, "wateringCan", "garden");
  generateWateringCan("holding", scene, x, (z + 10), -1000, camera, "wateringCan", "garden");
  generateWateringCan("pouring", scene, x, (z + 10), -1000, camera, "wateringCan", "garden");
  global_objects.push({id: "", type: "holdable", name: "wateringCan", puzzle_pos: {x: x, z: (z + 10), y: 4}});

  let fence1 = MeshBuilder.CreateBox("box", {width: 1, height: 1, depth: 9.5, wrap: true, faceUV: genCubeFaceUV([0.5, 0.5, 0.5, 0.5, 4.75, 0.5, 4.75, 0.5, 0.5, 4.75, 0.5, 4.75])}, scene);
  fence1.position.y = 0.5;
  fence1.position.x = x - 15;
  fence1.position.z = z + 20.25;
  fence1.material = new StandardMaterial('texture1', scene);
  fence1.material.diffuseTexture = returnWoodTexture("wood_darkbrown", scene);
  global_objects.push({id: fence1.uniqueId, obstacle8_id: item_id, type: "structure", name: ""});

  let fence2 = MeshBuilder.CreateBox("box", {width: 10.5, height: 1, depth: 1, wrap: true, faceUV: genCubeFaceUV([5.25, 0.5, 5.25, 0.5, 0.5, 0.5, 0.5, 0.5, 5.25, 0.5, 5.25, 0.5])}, scene);
  fence2.position.y = 0.5;
  fence2.position.x = x - 19.75;
  fence2.position.z = z + 15;
  fence2.material = new StandardMaterial('texture1', scene);
  fence2.material.diffuseTexture = returnWoodTexture("wood_darkbrown", scene);

  let fence3 = MeshBuilder.CreateBox("box", {width: 1, height: 1, depth: 9.5, wrap: true, faceUV: genCubeFaceUV([0.5, 0.5, 0.5, 0.5, 4.75, 0.5, 4.75, 0.5, 0.5, 4.75, 0.5, 4.75])}, scene);
  fence3.position.y = 0.5;
  fence3.position.x = x + 15;
  fence3.position.z = z - 20.25;
  fence3.material = new StandardMaterial('texture1', scene);
  fence3.material.diffuseTexture = returnWoodTexture("wood_darkbrown", scene);

  let fence4 = MeshBuilder.CreateBox("box", {width: 10.5, height: 1, depth: 1, wrap: true, faceUV: genCubeFaceUV([5.25, 0.5, 5.25, 0.5, 0.5, 0.5, 0.5, 0.5, 5.25, 0.5, 5.25, 0.5])}, scene);
  fence4.position.y = 0.5;
  fence4.position.x = x + 19.75;
  fence4.position.z = z - 15;
  fence4.material = new StandardMaterial('texture1', scene);
  fence4.material.diffuseTexture = returnWoodTexture("wood_darkbrown", scene);

  let fence5 = MeshBuilder.CreateBox("box", {width: 1, height: 1, depth: 9.5, wrap: true, faceUV: genCubeFaceUV([0.5, 0.5, 0.5, 0.5, 4.75, 0.5, 4.75, 0.5, 0.5, 4.75, 0.5, 4.75])}, scene);
  fence5.position.y = 0.5;
  fence5.position.x = x - 15;
  fence5.position.z = z - 20.25;
  fence5.material = new StandardMaterial('texture1', scene);
  fence5.material.diffuseTexture = returnWoodTexture("wood_darkbrown", scene);

  let fence6 = MeshBuilder.CreateBox("box", {width: 10.5, height: 1, depth: 1, wrap: true, faceUV: genCubeFaceUV([5.25, 0.5, 5.25, 0.5, 0.5, 0.5, 0.5, 0.5, 5.25, 0.5, 5.25, 0.5])}, scene);
  fence6.position.y = 0.5;
  fence6.position.x = x - 19.75;
  fence6.position.z = z - 15;
  fence6.material = new StandardMaterial('texture1', scene);
  fence6.material.diffuseTexture = returnWoodTexture("wood_darkbrown", scene);

  let fence7 = MeshBuilder.CreateBox("box", {width: 1, height: 1, depth: 9.5, wrap: true, faceUV: genCubeFaceUV([0.5, 0.5, 0.5, 0.5, 4.75, 0.5, 4.75, 0.5, 0.5, 4.75, 0.5, 4.75])}, scene);
  fence7.position.y = 0.5;
  fence7.position.x = x + 15;
  fence7.position.z = z + 20.25;
  fence7.material = new StandardMaterial('texture1', scene);
  fence7.material.diffuseTexture = returnWoodTexture("wood_darkbrown", scene);

  let fence8 = MeshBuilder.CreateBox("box", {width: 10.5, height: 1, depth: 1, wrap: true, faceUV: genCubeFaceUV([5.25, 0.5, 5.25, 0.5, 0.5, 0.5, 0.5, 0.5, 5.25, 0.5, 5.25, 0.5])}, scene);
  fence8.position.y = 0.5;
  fence8.position.x = x + 19.75;
  fence8.position.z = z + 15;
  fence8.material = new StandardMaterial('texture1', scene);
  fence8.material.diffuseTexture = returnWoodTexture("wood_darkbrown", scene);
  ...
  let cactusTrunk = MeshBuilder.CreateCylinder("cylinder", {diameter: 0.5, height: 4, tessellation: 8, faceUV: genCylinderFaceUV([0, 0, 1, 4, 0, 0])}, scene);
  cactusTrunk.position.y = 2.5;

  let cactusLeftArm = MeshBuilder.CreateCylinder("cylinder", {diameter: 0.5, height: 1.5, tessellation: 8, faceUV: genCylinderFaceUV([0, 0, 1.5, 1, 0, 0])}, scene);
  cactusLeftArm.position.y = 3.75;
  cactusLeftArm.position.x = 1;

  let cactusRightArm = MeshBuilder.CreateCylinder("cylinder", {diameter: 0.5, height: 1, tessellation: 8, faceUV: genCylinderFaceUV([0, 0, 1, 1, 0, 0])}, scene);
  cactusRightArm.position.y = 3;
  cactusRightArm.position.x = -1;

  let cactusLeftConnector = MeshBuilder.CreateCylinder("cylinder", {diameter: 0.5, height: 1, tessellation: 8, faceUV: genCylinderFaceUV([0, 0, 1, 1, 0, 0])}, scene);
  cactusLeftConnector.position.y = 3;
  cactusLeftConnector.position.x = 0.5;
  cactusLeftConnector.rotation.z = Math.PI / 2;

  let cactusRightConnector = MeshBuilder.CreateCylinder("cylinder", {diameter: 0.5, height: 1, tessellation: 8, faceUV: genCylinderFaceUV([0, 0, 1, 1, 0, 0])}, scene);
  ...
  let flowerStalk = MeshBuilder.CreateCylinder("cylinder", {diameter: 0.25, height: 3, tessellation: 8, faceUV: genCylinderFaceUV([0, 0, 1, 3, 0, 0])}, scene);
  ...
  let flowerLeaf1 = MeshBuilder.CreateCylinder("cylinder", {diameter: 0.5, height: 0.1, tessellation: 20, faceUV: genCylinderFaceUV([0.5, 0.5, 1, 0.25, 0.5, 0.5])}, scene);
  flowerLeaf1.position.y = 2.25;
  flowerLeaf1.position.x = 0.55;
  flowerLeaf1.rotation.z = Math.PI / 2;
  flowerLeaf1.rotation.y = Math.PI / 2;

  let flowerLeaf2 = MeshBuilder.CreateCylinder("cylinder", {diameter: 0.5, height: 0.1, tessellation: 20, faceUV: genCylinderFaceUV([0.5, 0.5, 1, 0.25, 0.5, 0.5])}, scene);
  flowerLeaf2.position.y = 2.25;
  flowerLeaf2.position.x = -0.55;
  flowerLeaf2.rotation.z = Math.PI / 2;
  flowerLeaf2.rotation.y = Math.PI / 2;

  let flowerLeaf3 = MeshBuilder.CreateCylinder("cylinder", {diameter: 0.5, height: 0.1, tessellation: 20, faceUV: genCylinderFaceUV([0.5, 0.5, 1, 0.25, 0.5, 0.5])}, scene);
  flowerLeaf3.position.y = 1.5;
  flowerLeaf3.position.x = 0.55;
  flowerLeaf3.rotation.z = Math.PI / 2;
  flowerLeaf3.rotation.y = Math.PI / 2;

  let flowerLeaf4 = MeshBuilder.CreateCylinder("cylinder", {diameter: 0.5, height: 0.1, tessellation: 20, faceUV: genCylinderFaceUV([0.5, 0.5, 1, 0.25, 0.5, 0.5])}, scene);
  ...
  let petal1 = MeshBuilder.CreateCylinder("cylinder", {diameter: 1.5, height: 0.1, tessellation: 20, faceUV: genCylinderFaceUV([0.75, 0.75, 1, 0.25, 0.75, 0.75])}, scene);
  petal1.position.y = 3;
  ...
  let petal2 = MeshBuilder.CreateCylinder("cylinder", {diameter: 1.5, height: 0.1, tessellation: 20, faceUV: genCylinderFaceUV([0.75, 0.75, 1, 0.25, 0.75, 0.75])}, scene);
  petal2.position.y = 3;
  ...
  let petal3 = MeshBuilder.CreateCylinder("cylinder", {diameter: 1.5, height: 0.1, tessellation: 20, faceUV: genCylinderFaceUV([0.75, 0.75, 1, 0.25, 0.75, 0.75])}, scene);
  petal3.position.y = 4.25;
  petal3.position.z = -0.3;
  petal3.rotation.z = Math.PI / 2;
  petal3.rotation.y = Math.PI / 2;

  let petal4 = MeshBuilder.CreateCylinder("cylinder", {diameter: 1.5, height: 0.1, tessellation: 20, faceUV: genCylinderFaceUV([0.75, 0.75, 1, 0.25, 0.75, 0.75])}, scene);
  ...
  generateWaterWell(scene, x, z, 0, "waterWell");
}
