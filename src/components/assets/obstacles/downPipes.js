...
function downPipes(x, z, scene, global_objects, item_id, camera) {
  ...
  pipeColors = arrayShuffler(pipeColors);

  let plateColors = [
    {color_name: "pink", inv_name: "Pink", color_code: new Color3(0.99, 0.1, 0.54)},
    {color_name: "blue", inv_name: "Blue", color_code: new Color3(0, 0.79, 0.99)},
    {color_name: "red", inv_name: "Red", color_code: new Color3(0.59, 0.13, 0.13)},
    {color_name: "purple", inv_name: "Purple", color_code: new Color3(0.25, 0.05, 0.41)}
  ];
  ...
  pipe1base.material.diffuseColor = pipeColors[0];
  ...
  pipe1joint.material.diffuseColor = pipeColors[0];
  ...
  pipe1arm.material.diffuseColor = pipeColors[0];
  ...
  pipe1rim.material.diffuseColor = pipeColors[0];
  ...
  pipe1Barrier.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  pipe2base_exit.material.diffuseColor = pipeColors[1];
  ...
  pipe2joint_exit.material.diffuseColor = pipeColors[1];
  ...
  pipe2arm_exit.material.diffuseColor = pipeColors[1];
  ...
  pipe2rim_exit.material.diffuseColor = pipeColors[1];
  ...
  pipe2Barrier_exit.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  plate2holder.material.diffuseColor = plateColors[1].color_code;
  ...
  pipe2base.material.diffuseColor = pipeColors[1];
  ...
  pipe2joint.material.diffuseColor = pipeColors[1];
  ...
  pipe2arm.material.diffuseColor = pipeColors[1];
  ...
  pipe2rim.material.diffuseColor = pipeColors[1];
  ...
  pipe2Barrier.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  pipe3base_exit.material.diffuseColor = pipeColors[2];
  ...
  pipe3joint_exit.material.diffuseColor = pipeColors[2];
  ...
  pipe3arm_exit.material.diffuseColor = pipeColors[2];
  ...
  pipe3rim_exit.material.diffuseColor = pipeColors[2];
  ...
  pipe3Barrier_exit.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  plate3holder.material.diffuseColor = plateColors[2].color_code;
  ...
  pipe3base.material.diffuseColor = pipeColors[2];
  ...
  pipe3joint.material.diffuseColor = pipeColors[2];
  ...
  pipe3arm.material.diffuseColor = pipeColors[2];
  ...
  pipe3rim.material.diffuseColor = pipeColors[2];
  ...
  pipe3Barrier.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  pipe4base_exit.material.diffuseColor = pipeColors[3];
  ...
  pipe4joint_exit.material.diffuseColor = pipeColors[3];
  ...
  pipe4arm_exit.material.diffuseColor = pipeColors[3];
  ...
  pipe4rim_exit.material.diffuseColor = pipeColors[3];
  ...
  pipe4Barrier_exit.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  plate4holder.material.diffuseColor = plateColors[3].color_code;
  ...
  plate4support.material.diffuseColor = new Color3(0.19, 0.18, 0.18);
  ...
  pipe4base.material.diffuseColor = pipeColors[3];
  ...
  pipe4joint.material.diffuseColor = pipeColors[3];
  ...
  pipe4arm.material.diffuseColor = pipeColors[3];
  ...
  pipe4rim.material.diffuseColor = pipeColors[3];
  ...
  pipe4Barrier.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  pipe1base_exit.material.diffuseColor = pipeColors[0];
  ...
  pipe1joint_exit.material.diffuseColor = pipeColors[0];
  ...
  pipe1arm_exit.material.diffuseColor = pipeColors[0];
  ...
  pipe1rim_exit.material.diffuseColor = pipeColors[0];
  ...
  pipe1Barrier_exit.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  plate1holder.material.diffuseColor = plateColors[0].color_code;
  ...
  ball1sphere.material.diffuseColor = ballColors[0].color_code;
  ...
  ball1Barrier.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  ball1.name = "ball1";
  global_objects.push({id: ball1.uniqueId, obstacle_id: item_id, type: "ball_Ob9", name: (ballColors[0].color_name + "_ball"), inventory: (ballColors[0].inv_name + " Ball"), img: (ballColors[0].color_name + "_ball"), color_code: ballColors[0].color_code, color_name: ballColors[0].color_name});
  ...
  ball2sphere.material.diffuseColor = ballColors[1].color_code;
  ...
  ball2Barrier.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  ball2.name = "ball2";
  global_objects.push({id: ball2.uniqueId, obstacle_id: item_id, type: "ball_Ob9", name: (ballColors[1].color_name + "_ball"), inventory: (ballColors[1].inv_name + " Ball"), img: (ballColors[1].color_name + "_ball"), color_code: ballColors[1].color_code, color_name: ballColors[1].color_name});
  ...
  ball3sphere.material.diffuseColor = ballColors[2].color_code;
  ...
  ball3Barrier.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  ball3.name = "ball3";
  global_objects.push({id: ball3.uniqueId, obstacle_id: item_id, type: "ball_Ob9", name: (ballColors[2].color_name + "_ball"), inventory: (ballColors[2].inv_name + " Ball"), img: (ballColors[2].color_name + "_ball"), color_code: ballColors[2].color_code, color_name: ballColors[2].color_name});
  ...
  ball4sphere.material.diffuseColor = ballColors[3].color_code;
  ...
  ball4Barrier.material.diffuseColor = new Color3(0.26, 0.17, 0.05);
  ...
  ball4.name = "ball4";
  global_objects.push({id: ball4.uniqueId, obstacle_id: item_id, type: "ball_Ob9", name: (ballColors[3].color_name + "_ball"), inventory: (ballColors[3].inv_name + " Ball"), img: (ballColors[3].color_name + "_ball"), color_code: ballColors[3].color_code, color_name: ballColors[3].color_name});
}
