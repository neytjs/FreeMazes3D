...
function bulbMatch(x, z, scene, global_objects, item_id, camera) {
  ...
  let pedestal = MeshBuilder.CreateBox("box", {width: 30, height: 1, depth: 10, wrap: true}, scene);
  ...
  pedestal.material.diffuseTexture.uScale = 4;
  pedestal.material.diffuseTexture.vScale = 2;
  ...
  let buttonHolder4 = MeshBuilder.CreateBox("box", {width: 2, height: 3, depth: 2}, scene);
  ...
  let hintBarrier = MeshBuilder.CreateBox("box", {width: 5, height: 4, depth: 6}, scene);
