...
import {returnCrystalTexture, returnWoodTexture, genCylinderFaceUV} from "../textures.js";

function generateMagicPowder(num, obstacle_objects, scene, global_language) {
  ...
  obstacle_objects.push({id: powder.uniqueId, type: "powder_Ob13", name: (plateColors[num].color_name + "_powder"), inventory: (plateColors[num].inv_name + global_language.text.items.puzzles.powder), img: (plateColors[num].color_name + "_powder"), color_code: plateColors[num].color_code, color_name: plateColors[num].color_name});
