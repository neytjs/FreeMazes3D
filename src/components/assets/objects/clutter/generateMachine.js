...
function generateMachine(x, z, scene) {
  ...
  box1.material.diffuseColor = new Color3(0.34, 0.32, 0.32);
  ...
  pipe1.material.diffuseColor = new Color3(0.34, 0.32, 0.32);
  ...
  pipe2.material.diffuseColor = new Color3(0.34, 0.32, 0.32);
  ...
  pipe3.material.diffuseColor = new Color3(0.34, 0.32, 0.32);
  ...
  pipe4.material.diffuseColor = new Color3(0.34, 0.32, 0.32);
  ...
  rim1.material.diffuseColor = new Color3(0.1, 0.1, 0.1);
  ...
  rim2.material.diffuseColor = new Color3(0.1, 0.1, 0.1);
