...
function handleButtonPressOb16(buttons, ob16, scene, obstacle_objects, forcefield_objects, score, solved) {
  if (buttons.pushingButton === "pushButton1p16") {
    ...
    startTimerOb16(ob16, scene, obstacle_objects, forcefield_objects, score, solved);
  }
