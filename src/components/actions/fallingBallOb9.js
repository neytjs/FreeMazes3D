...
function fallingBallOb9(solved, ob9, scene, score, obstacle_objects, forcefield_objects, global_language) {
  if (solved.solvedP9 === false) {
    ...
    if (ob9.hiddenBall1falling) {
      ...
      if (hiddenBall.position.y > end) {
        ...
        ballLandsOb9(ob9, obstacle_objects, forcefield_objects, solved, scene, score, "hiddenBall1", 1, global_language);
      }
    }
    if (ob9.hiddenBall2falling) {
      ...
      if (hiddenBall.position.y > end) {
        ...
        ballLandsOb9(ob9, obstacle_objects, forcefield_objects, solved, scene, score, "hiddenBall2", 2, global_language);
      }
    }
    if (ob9.hiddenBall3falling) {
      ...
      if (hiddenBall.position.y > end) {
        ...
        ballLandsOb9(ob9, obstacle_objects, forcefield_objects, solved, scene, score, "hiddenBall3", 3, global_language);
      }
    }
    if (ob9.hiddenBall4falling) {
      ...
      if (hiddenBall.position.y > end) {
        ...
        ballLandsOb9(ob9, obstacle_objects, forcefield_objects, solved, scene, score, "hiddenBall4", 4, global_language);
      }
    }
  }
}
