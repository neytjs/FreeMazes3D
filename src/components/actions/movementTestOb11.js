...
function movementTestOb11(solved, ob11, camera, scene, score, forcefield_objects, obstacle_objects) {
  if (solved.solvedP11 === false && ob11.firing === false) {
    ...
    if (turret && Vector3.Distance(camera.position, turret.position) < 50) {
      ...
      rotateTurretOb11(solved, scene, atan2, ob11, score, forcefield_objects, obstacle_objects);
    }
  }
}
